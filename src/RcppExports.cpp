...
RcppExport SEXP _statideas_c_test(SEXP testSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _statideas_c_two_arm_diff(SEXP datSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _statideas_c_mtp_single(SEXP p_valuesSEXP, SEXP alphasSEXP, SEXP mat_gSEXP, SEXP logSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _statideas_c_mtp(SEXP p_valuesSEXP, SEXP alphasSEXP, SEXP mat_gSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _statideas_c_mtp_step(SEXP mat_gSEXP, SEXP weightsSEXP, SEXP h_indSEXP, SEXP p_valuesSEXP, SEXP alphaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type mat_g(mat_gSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_statideas_c_test", (DL_FUNC) &_statideas_c_test, 1},
    {"_statideas_c_two_arm_diff", (DL_FUNC) &_statideas_c_two_arm_diff, 1},
    {"_statideas_c_mtp_single", (DL_FUNC) &_statideas_c_mtp_single, 4},
    {"_statideas_c_mtp", (DL_FUNC) &_statideas_c_mtp, 3},
    {"_statideas_c_mtp_step", (DL_FUNC) &_statideas_c_mtp_step, 5},
...
RcppExport void R_init_statideas(DllInfo *dll) {
